          ...
          open (3,file='14.15_euler9scale1.dat',status='unknown')
          open(9,file='14.15sc1.dat',status='unknown')
          open(7,file='14.15mod1.dat',status='unknown')
          open(5,file='14.15sc0.dat',status='unknown')
          open(11,file='out1_14.15.dat',status='unknown')
         
          open(1,file='14.15.dat',status='unknown')
