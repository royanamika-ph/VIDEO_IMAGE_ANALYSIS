          ...
          open (3,file='15.42_euler9scale1.dat',status='unknown')
          open(9,file='15.42sc1.dat',status='unknown')
          open(7,file='15.42mod1.dat',status='unknown')
          open(5,file='15.42sc0.dat',status='unknown')
          open(11,file='out1_15.42.dat',status='unknown')
         
          open(1,file='15.42.dat',status='unknown')
