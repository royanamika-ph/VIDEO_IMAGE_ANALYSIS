          ...
          open(3,file='15.42_eul_sc_up7.dat',status='unknown')
          open(9,file='15.42sc7.dat',status='unknown')
          open(7,file='15.42m0d7.dat',status='unknown')
          open(5,file='15.42sc6_up.dat',status='unknown')
          open(11,file='out5_15.42.dat',status='unknown')
         
          open(1,file='out6_15.42.dat',status='unknown')
