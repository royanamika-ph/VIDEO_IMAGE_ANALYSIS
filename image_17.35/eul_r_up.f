          ...
          open(3,file='17.35_eul_sc_up7.dat',status='unknown')
          open(9,file='17.35sc7.dat',status='unknown')
          open(7,file='17.35m0d7.dat',status='unknown')
          open(5,file='17.35sc6_up.dat',status='unknown')
          open(11,file='out7_17.35.dat',status='unknown')
         
          open(1,file='out6_17.35.dat',status='unknown')
