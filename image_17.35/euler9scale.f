          ...
          parameter (a=1,n=465,sc=1)
          dimension r(930,930),rhex(n,n),xpoint(n,n),ypoint(n,n)
          ...
          open (3,file='17.35_euler9scale1.dat',status='unknown')
          open(9,file='17.35sc1.dat',status='unknown')
          open(7,file='17.35mod1.dat',status='unknown')
          open(5,file='17.35sc0.dat',status='unknown')
          open(11,file='out1_17.35.dat',status='unknown')
         
          open(1,file='17.35.dat',status='unknown')
       ...
       do itrial =1,trial
         ...
         ! write(*,*),p
          ...
          rhex(i,j)= r((2*(i-1)+1),(2*j))
          else
          rhex(i,j)=r((2*(i-1)+1),(2*(j-1)+1))
